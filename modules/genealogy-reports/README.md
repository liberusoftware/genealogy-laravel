...
This independent Liberu module owns the provider-neutral **Genealogy Reports** capability.
...
- Composer package: `liberusoftware/module-genealogy-reports`
- Module installer name: `genealogy-reports`
- Category: capability
