...
final class DnaKit extends Model
{
    ...
    protected $fillable = ['team_id', 'name', 'provider', 'provider_id', 'external_id', 'person_id', 'test_type', 'consent_status', 'consented_at', 'revoked_at', 'revocation_reason', 'status', 'metadata'];
