...
This independent Liberu module owns the provider-neutral **Genealogy Places** capability.
...
- Composer package: `liberusoftware/module-genealogy-places`
- Module installer name: `genealogy-places`
- Category: capability
