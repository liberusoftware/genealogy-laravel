...
This independent Liberu module owns the provider-neutral **Genealogy Evidence** capability.
...
- Composer package: `liberusoftware/module-genealogy-evidence`
- Module installer name: `genealogy-evidence`
- Category: capability
